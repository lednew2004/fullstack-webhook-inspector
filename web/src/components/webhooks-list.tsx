...
import { WebhookslistItems } from './webhooks-list-items'
    ...
    <>
      <div className="flex-1 overflow-y-auto">
        ...
        <Dialog.Root defaultOpen>
          ...
          <Dialog.Content className="fixed left-1/2 top-1/2 z-40 w-[90vw] max-w-[700px] -translate-x-1/2 -translate-y-1/2">
            <Dialog.Title className="sr-only">Código do handler</Dialog.Title>

            <Dialog.Description className="sr-only">
              Modal contendo o código TypeScript gerado automaticamente.
            </Dialog.Description>

            <div className="bg-zinc-900 p-4 rounded-lg border border-zinc-800 max-h-[620px] overflow-y-auto">
